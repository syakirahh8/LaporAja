            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Formulir Pengajuan Laporan</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-masyarakat">Isi data berikut untuk memulai prosesnya!</h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-masyarakat">Submit</button>
                                    </form>
                                </div>
