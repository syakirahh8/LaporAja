                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <dotlottie-player src="https://lottie.host/fc04990a-9f10-4071-8bda-2a328354e1c7/QkBW1uPFv4.lottie" background="transparent" speed="1" style="width: 500px; height: 500px;" loop autoplay></dotlottie-player>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h3 class="h6 text-gray-900">LaporAja menyambut Anda! Mari bersama ciptakan solusi.</h3>
                                    </div>
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <button type="submit" name="login" class="btn btn-pink btn-user btn-block">Login</button>
                                    </form>
